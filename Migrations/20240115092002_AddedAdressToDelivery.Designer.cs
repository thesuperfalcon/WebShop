...
namespace WebShop.Migrations
{
    ...
    [Migration("20240115092002_AddedAdressToDelivery")]
    partial class AddedAdressToDelivery
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdressDelivery", b =>
                {
                    ...
                    b.HasKey("AdressesId", "DeliveriesId");

                    b.HasIndex("DeliveriesId");

                    b.ToTable("AdressDelivery");
                });
            ...
            modelBuilder.Entity("WebShop.Models.DeliveryName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebShop.Models.PaymentName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AdressDelivery", b =>
                {
                    b.HasOne("WebShop.Models.Adress", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebShop.Models.Delivery", b =>
                {
                    b.HasOne("WebShop.Models.DeliveryName", "DeliveryName")
                        .WithMany("Deliveries")
            ...
            modelBuilder.Entity("WebShop.Models.Payment", b =>
                {
                    b.HasOne("WebShop.Models.PaymentName", "PaymentName")
                        .WithMany("Payments")
